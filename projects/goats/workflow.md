...
|---|---|---|---|
| Staging Areas | `output/staging.shp` | Circle marker, 3 mm, medium orange (210,120,0) + dark orange outline | Reproject `data/staging.geojson` → EPSG:26910 |
