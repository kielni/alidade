...
Source: output/hotspots_income.shp (generated from output/household_income.shp).
...
hotspots_income = Layer(
    id="hotspots_income",
    name="Hot Spot Analysis (MedianHH_i)",
    type="vector",
    inputs=[household_income],
    datasource="output/hotspots_income.shp",
    provider="ogr",
    crs="EPSG:2227",
    visible=True,
